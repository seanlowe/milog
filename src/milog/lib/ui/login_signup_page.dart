...
class _LoginSignUpPageState extends State<LoginSignUpPage> {
  ...
  // function acts as a bridge to functions
  // that build the content of the page
  Widget _showBody(){
  ...
  // supporting function of _validateAndSubmit()
...
} // end of class _LoginSignUpPageState